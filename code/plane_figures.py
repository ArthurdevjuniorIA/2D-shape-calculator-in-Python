...
def unit_converter(value):
    if unidade_de_measure == "km":
       only_value = float(value)*1000
    elif unidade_de_measure == "hm":
        only_value = float(value)*100
    elif unidade_de_measure == "dam":
        only_value = float(value)*10
    elif unidade_de_measure == "dm":
        only_value = float(value)/10
    elif unidade_de_measure == "cm":
        only_value = float(value)/100
    elif unidade_de_measure == "mm":
        only_value = float(value)/1000
    else:
        pass
    return only_value
...
try:
    while True:
        if which_figure_uppercase == "FIM":
            ...
            only_value, unidade_de_measure = measure_1.split()
            ...
            only_value_2, unidade_de_measure = measure_2.split()
            ...
            if only_value<=0 or only_value_2<=0:
                ...
                if which_figure_uppercase == "RETANGULO" or which_figure_uppercase == "PARALELOGRAMO" or which_figure_uppercase== "QUADRADO":
                    ...
                    only_value_3, unidade_de_measure = measure_3.split()
            ...
            if which_figure_uppercase == "PENTAGONO":
                ...
                only_value, unidade_de_measure = lado.split()       
